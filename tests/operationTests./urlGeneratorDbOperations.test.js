...
describe('In dbUtils', () => {
	describe('The function insertUrls', () => {
		it ('should create an entry in urls', async() => {
			...
			mockCreateUrl.mockResolvedValue({'longurl':'https://www.github.com/shubhamzanwar', 'shorturl': 'localhost:8080/abcd'});
			...
			// expect(result).toBe({'longurl':'https://www.github.com/shubhamzanwar', 'shorturl': 'localhost:8080/abcd'});
